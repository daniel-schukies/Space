...
public abstract class Ship {
	...
	private String ship = "/resource/star.png";
    private int dx;
    private int dy;
    private int x;
    private int y;
    ...
    public Ship(Dimension space, int[] mousePosition, int x, int y) 
    {
    	this.degree = 0;
        ...
        try 
        {
			BufferedImage image = ImageIO.read(getClass().getResource(ship));
